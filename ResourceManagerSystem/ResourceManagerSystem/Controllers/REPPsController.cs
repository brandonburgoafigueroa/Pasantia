...
namespace ResourceManagerSystem.Controllers
{
    public class REPPsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Code,Name,Size,Brand,Color")] REPP rEPP)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var rEPP = await _context.REPPS.SingleOrDefaultAsync(m => m.ID == id);
            if (rEPP == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Code,Name,Size,Brand,Color")] REPP rEPP)
        {
            if (id != rEPP.ID)
            {
                return NotFound();
        ...
        {
            return _context.REPPS.Any(e => e.ID == id);
        }
    }
}
