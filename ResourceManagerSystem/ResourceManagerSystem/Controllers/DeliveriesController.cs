...
namespace ResourceManagerSystem.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeliveryID,ReppID,LotID,Quantity,Description")] Delivery delivery)
        {
            ...
            ViewData["ReppID"] = new SelectList(_context.REPPS, "ReppID", "Brand", delivery.ReppID);
            return View(delivery);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeliveryID,ReppID,LotID,Quantity,Description")] Delivery delivery)
        {
